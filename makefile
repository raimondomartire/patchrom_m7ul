...
#local-miui-modified-apps := Settings Phone Mms ThemeManager MiuiSystemUI
...
InputDevices GMS_Maps Magazines PlusOne Street OccamQuickOffice LatinImeDictionaryPack SetupWizard \
 Velvet GoogleEars LatinImeGoogle Superuser BasicDreams DeskClockGoogle GoogleCurrents FusedLocation Gmail2 
